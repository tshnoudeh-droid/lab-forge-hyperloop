...
export default function ShellSpecPanel({ hotspotId, onClose }: ShellSpecPanelProps) {
  const hotspot = SHELL_HOTSPOTS.find((h) => h.id === hotspotId) ?? null;
